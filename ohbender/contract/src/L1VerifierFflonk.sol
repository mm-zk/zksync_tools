...
import {IVerifierV2} from "src/DualVerifier.sol";
...
contract L1VerifierFflonk is IVerifierV2 {
    ...
    uint256 internal constant VK_C0_G1_X =
        0x19bd7a8cb4cb56772e1a67453c37c9657164a60b05a2d5dbe48de94b80a8563e;
    uint256 internal constant VK_C0_G1_Y =
        0x1891e1b2512fd626bdd1e82d967ef7f327610799c6548e71283c5b932eaf5370;
    ...
    uint256 internal constant VK_G2_ELEMENT_0_X1 =
        0x198e9393920d483a7260bfb731fb5d25f1aa493335a9e71297e485b7aef312c2;
    uint256 internal constant VK_G2_ELEMENT_0_X2 =
        0x1800deef121f1e76426a00665e5c4479674322d4f75edadd46debd5cd992f6ed;
    uint256 internal constant VK_G2_ELEMENT_0_Y1 =
        0x090689d0585ff075ec9e99ad690c3395bc4b313370b38ef355acdadcd122975b;
    uint256 internal constant VK_G2_ELEMENT_0_Y2 =
        0x12c85ea5db8c6deb4aab71808dcb408fe3d1e7690c43d37b4ce6cc0166fa7daa;
    uint256 internal constant VK_G2_ELEMENT_1_X1 =
        0x260e01b251f6f1c7e7ff4e580791dee8ea51d87a358e038b4efe30fac09383c1;
    uint256 internal constant VK_G2_ELEMENT_1_X2 =
        0x0118c4d5b837bcc2bc89b5b398b5974e9f5944073b32078b7e231fec938883b0;
    uint256 internal constant VK_G2_ELEMENT_1_Y1 =
        0x04fc6369f7110fe3d25156c1bb9a72859cf2a04641f99ba4ee413c80da6a5fe4;
    uint256 internal constant VK_G2_ELEMENT_1_Y2 =
    ...
    uint256 internal constant OMEGA =
        0x1283ba6f4b7b1a76ba2008fe823128bea4adb9269cbfd7c41c223be65bc60863;
    // =========================================
    ...
    uint256 internal constant MEM_PROOF_PUBLIC_INPUT_SLOT =
        0x264 + 0x1c0 + 0x2e0;

    uint256 internal constant MEM_PROOF_COMMITMENT_0_G1_X =
        0x264 + 0x1c0 + 0x2e0 + 0x20;
    uint256 internal constant MEM_PROOF_COMMITMENT_0_G1_Y =
        0x264 + 0x1c0 + 0x2e0 + 0x40;
    uint256 internal constant MEM_PROOF_COMMITMENT_1_G1_X =
        0x264 + 0x1c0 + 0x2e0 + 0x60;
    uint256 internal constant MEM_PROOF_COMMITMENT_1_G1_Y =
        0x264 + 0x1c0 + 0x2e0 + 0x80;
    uint256 internal constant MEM_PROOF_COMMITMENT_2_G1_X =
        0x264 + 0x1c0 + 0x2e0 + 0xa0;
    uint256 internal constant MEM_PROOF_COMMITMENT_2_G1_Y =
        0x264 + 0x1c0 + 0x2e0 + 0xc0;
    uint256 internal constant MEM_PROOF_COMMITMENT_3_G1_X =
        0x264 + 0x1c0 + 0x2e0 + 0xe0;
    uint256 internal constant MEM_PROOF_COMMITMENT_3_G1_Y =
        0x264 + 0x1c0 + 0x2e0 + 0x100;

    uint256 internal constant MEM_PROOF_EVALUATIONS =
        0x264 + 0x1c0 + 0x2e0 + 0x120; // 15 slots

    uint256 internal constant MEM_PROOF_MONTGOMERY_LAGRANGE_BASIS_INVERSE =
        0x264 + 0x1c0 + 0x2e0 + 0x120 + 0x1e0; // 1 slots

    uint256 internal constant MEM_LAGRANGE_BASIS_DENOMS =
        0x264 + 0x1c0 + 0x2e0 + 0x120 + 0x200; //18 slots
    uint256 internal constant MEM_LAGRANGE_BASIS_DENOM_PRODUCTS =
        0x264 + 0x1c0 + 0x2e0 + 0x120 + 0x440; // 18 slots
    uint256 internal constant MEM_PROOF_LAGRANGE_BASIS_EVALS =
        0x264 + 0x1c0 + 0x2e0 + 0x120 + 0x680; // 18 Slots
    ...
    function verify(
        ...
        assembly {
            ...
            function load_inputs() {
                ...
                let publicInputLengthInWords := calldataload(
                    add(publicInputOffset, 0x04)
                )
                // We expect only one public input
                if iszero(
                    eq(publicInputLengthInWords, PROOF_PUBLIC_INPUTS_LENGTH)
                ) {
                    revertWithMessage(32, "public input length is incorrect")
                }
                mstore(
                    MEM_PROOF_PUBLIC_INPUT_SLOT,
                    mod(calldataload(add(publicInputOffset, 0x24)), R_MOD)
                )

                // 2. Load proof
                let proofLengthOffset := calldataload(0x24)
                let proofLengthInWords := calldataload(
                    add(proofLengthOffset, 0x04)
                )
                ...
                for {
                    ...
                    let eval := mod(
                        calldataload(add(proofOffset, mul(i, 0x20))),
                        R_MOD
                    )
                ...
                proofOffset := add(
                    proofOffset,
                    mul(PROOF_EVALUATIONS_LENGTH, 0x20)
                )

                mstore(
                    MEM_PROOF_MONTGOMERY_LAGRANGE_BASIS_INVERSE,
                    mod(calldataload(proofOffset), R_MOD)
                )
            }
            ...
            function initialize_transcript() {
                ...
                for {
                    ...
                    update_transcript(
                        mload(add(MEM_PROOF_PUBLIC_INPUT_SLOT, mul(i, 0x20)))
                    )
                }
                ...
                mstore(
                    PVS_ALPHA_1,
                    mulmod(mload(PVS_ALPHA_0), mload(PVS_ALPHA_0), R_MOD)
                )
                // commit w(X)
                ...
                mstore(
                    PVS_VANISHING_AT_Z,
                    addmod(
                        modexp(mload(PVS_Z), DOMAIN_SIZE),
                        sub(R_MOD, ONE),
                        R_MOD
                    )
                )
                ...
                mstore(
                    ...
                    modexp(
                        mulmod(
                            addmod(mload(PVS_Z), sub(R_MOD, ONE), R_MOD),
                            DOMAIN_SIZE,
                            R_MOD
                        ),
                        sub(R_MOD, 2)
                ...
                mstore(
                    ...
                    mulmod(
                        mload(PVS_L_0_AT_Z),
                        mload(PVS_VANISHING_AT_Z),
                        R_MOD
                    )
                )
                mstore(
                    PVS_VANISHING_AT_Z_INV,
                    modexp(mload(PVS_VANISHING_AT_Z), sub(R_MOD, 2))
                )
            }
            ...
            function compute_main_gate_quotient() {
                ...
                rhs := addmod(
                    ...
                    mulmod(
                        mload(PVS_L_0_AT_Z),
                        mload(MEM_PROOF_PUBLIC_INPUT_SLOT),
                        R_MOD
                    ),
                    R_MOD
                )
                for {
                    ...
                    rhs := addmod(
                        ...
                        mulmod(
                            mload(add(MEM_PROOF_EVALUATIONS, mul(i, 0x20))),
                            mload(
                                add(MEM_PROOF_EVALUATIONS, mul(add(8, i), 0x20))
                            ),
                            R_MOD
                        ),
                        R_MOD
            ...
            function compute_copy_permutation_quotients() {
                ...
                let rhs := addmod(
                    addmod(
                        mulmod(
                            mulmod(mload(PVS_BETA), mload(PVS_Z), R_MOD),
                            VK_NON_RESIDUES_1,
                            R_MOD
                        ),
                        mload(PVS_GAMMA),
                ...
                tmp2 := mulmod(
                    mulmod(
                        addmod(
                            ...
                            mload(
                                add(MEM_PROOF_EVALUATIONS, mul(add(8, 2), 0x20))
                            ),
                            R_MOD
                        ),
                ...
                tmp := addmod(
                    addmod(
                        mulmod(
                            mload(PVS_BETA),
                            mload(add(MEM_PROOF_EVALUATIONS, mul(5, 0x20))),
                            R_MOD
                        ),
                        mload(PVS_GAMMA),
                        R_MOD
             ...
             */
            function precompute_partial_lagrange_basis_evaluations(
                start,
                num_polys,
                y,
                omega,
                ...
                if gt(
                    add(start, num_polys),
                    TOTAL_LAGRANGE_BASIS_INVERSES_LENGTH
                ) {
                ...
                for {
                    ...
                    mstore(
                        add(
                            MEM_LAGRANGE_BASIS_DENOMS,
                            mul(add(start, i), 0x20)
                        ),
                        tmp
                    )
                    ...
                    mstore(
                        add(
                            MEM_LAGRANGE_BASIS_DENOM_PRODUCTS,
                            mul(add(start, i), 0x20)
                        ),
                        product
                    )
                    ...
                    mstore(
                        add(
                            MEM_PROOF_LAGRANGE_BASIS_EVALS,
                            mul(add(start, i), 0x20)
                        ),
            ...
            function precompute_partial_lagrange_basis_evaluations_for_union_set(
                ...
                for {
                    ...
                    mstore(
                        add(
                            MEM_LAGRANGE_BASIS_DENOMS,
                            mul(add(add(start, num_polys), i), 0x20)
                        ),
                        t_0
                    )
            ...
            function precompute_all_lagrange_basis_evaluations_from_inverses() {
                ...
                let
                    product_0_17
                := precompute_partial_lagrange_basis_evaluations_for_union_set(
                    add(8, 4),
                    3,
                    y,
                ...
                let montgomery_inverse := mload(
                    MEM_PROOF_MONTGOMERY_LAGRANGE_BASIS_INVERSE
                )

                if iszero(
                    eq(mulmod(product_0_17, montgomery_inverse, R_MOD), 1)
                ) {
                ...
                for {
                    ...
                    temp := mulmod(
                        temp,
                        mload(add(MEM_LAGRANGE_BASIS_DENOMS, mul(i, 0x20))),
                        R_MOD
                    )
                }
                mstore(
            ...
            function compute_opening_points() {
                ...
                mstore(
                    ...
                    mulmod(
                        r_8,
                        0x0925f0bd364638ec3084b45fc27895f8f3f6f079096600fe946c8e9db9a47124,
                        R_MOD
                    )
                )
            }
            ...
            function evaluate_r_polys_at_point_unrolled(
                ...
                c := mulmod(
                    mload(add(MEM_PROOF_EVALUATIONS, mul(7, 0x20))),
                    omega_h,
                    R_MOD
                )
                for {
                    ...
                    c := mulmod(
                        addmod(
                            c,
                            mload(
                                add(MEM_PROOF_EVALUATIONS, mul(sub(7, i), 0x20))
                            ),
                            R_MOD
                        ),
                        omega_h,
                ...
                c := mulmod(
                    addmod(c, copy_perm_first_quotient_at_z, R_MOD),
                    omega_h,
                    R_MOD
                )
                c := addmod(
                ...
                // c2 shifted
                c := mulmod(
                    mload(add(MEM_PROOF_EVALUATIONS, mul(add(12, 2), 0x20))),
                    omega_h_shifted,
                    R_MOD
                )
                c := mulmod(
                    addmod(
                        c,
                        mload(
                            add(MEM_PROOF_EVALUATIONS, mul(add(12, 1), 0x20))
                        ),
                        R_MOD
                    ),
                    omega_h_shifted,
            ...
            function check_openings() -> out {
                ...
                // -(ζ*w)
                mstore(
                    add(PS_MINUS_Z, mul(1, 0x20)),
                    sub(R_MOD, mload(PVS_Z_OMEGA))
                )
                ...
                mstore(
                    ...
                    addmod(
                        mload(add(OPS_Y_POWS, mul(3, 0x20))),
                        mload(add(PS_MINUS_Z, mul(1, 0x20))),
                        R_MOD
                    )
                )
                tmp := addmod(
                    mload(add(OPS_Y_POWS, mul(3, 0x20))),
                    mload(add(PS_MINUS_Z, mul(0, 0x20))),
                    R_MOD
                )
                mstore(
                    add(PS_SET_DIFFERENCES_AT_Y, mul(0, 0x20)),
                    mulmod(
                        mload(add(PS_SET_DIFFERENCES_AT_Y, mul(0, 0x20))),
                        tmp,
                        R_MOD
                    )
                )
                tmp := addmod(
                    mload(add(OPS_Y_POWS, mul(4, 0x20))),
                    mload(add(PS_MINUS_Z, mul(0, 0x20))),
                    R_MOD
                )
                mstore(
                ...
                mstore(
                    add(PS_SET_DIFFERENCES_AT_Y, mul(1, 0x20)),
                    mulmod(
                        mload(add(PS_SET_DIFFERENCES_AT_Y, mul(1, 0x20))),
                        tmp,
                        R_MOD
                    )
                )
                tmp := addmod(
                    mload(add(OPS_Y_POWS, mul(8, 0x20))),
                    mload(add(PS_MINUS_Z, mul(0, 0x20))),
                    R_MOD
                )
                mstore(
                ...
                mstore(
                    PS_VANISHING_AT_Y,
                    mulmod(mload(PS_VANISHING_AT_Y), tmp, R_MOD)
                )
            ...
            function pairing_check(p1_x, p1_y, is_zero_commitment) -> res {
                ...
                if iszero(is_zero_commitment) {
                    mstore(
                        0x160,
                        sub(Q_MOD, mload(MEM_PROOF_COMMITMENT_3_G1_Y))
                    )
                }
